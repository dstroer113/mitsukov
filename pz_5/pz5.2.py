#Описать функцию TrianglePS(а, P, S), вычисляющую по стороне а равностороннего треугольника его периметр P = 3*а и площадь Ѕ a2 √3/4 
#(a входной, Р и S - выходные параметры; все параметры являются вещественными). 
